...
from MAPF_CBS.Stastar.planner import Planner as  STPlanner
from MAPF_CBS.constraint_tree import CTNode
from MAPF_CBS.constraints import Constraints
from MAPF_CBS.agent import Agent
from MAPF_CBS.assigner import *
class Planner:
    ...
    def plan(self, starts: List[Tuple[int, int]],
                   ...
                   assign:Callable = standard,
                #    max_iter:int = 1000,
                   max_iter:int = 200,
                #    low_level_max_iter:int = 5000,
